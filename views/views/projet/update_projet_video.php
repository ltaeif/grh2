   ...
   if (window.File && window.FileReader && window.FileList && window.Blob)
	{
        ...
        {	
            ...
            case 'video/mp4': case 'video/webm': case 'video/ogv': case 'video/3gp':   case 'video/x-flv': case 'video/x-msvideo': 
			//case 'video/x-ms-wmv' :
                break;
            default:
...
function bytesToSize(bytes) {
  ...
  <div class="form-actions">
	<a class="btn" href="index.php?page=projet&action=index#<?=$id_projet?>">Back</a>
  </div>
