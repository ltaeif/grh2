...
<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			Database::disconnect();
			header("Location: index.php?page=presse&action=index#".$id_presse);
		}
	}
	 else {
		$pdo = Database::connect();
    ...
    $(function() {
      ...
      $('form').on('submit', function (e) {
        ...
        //alert($('.summernote').code());
					...
					<form class="form-horizontal" action="index.php?page=presse&action=update_presse_lang&id=<?=$id;?>&id_presse=<?=$id_presse;?>" method="post"  id="MyUploadForm">
