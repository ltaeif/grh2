		...
		$id = $_POST['id'];
			...
			try { 
						...
						try { 
							...
							//delete from folder
							if(file_exists(_ASS_UPLOAD_VIDEO_PRESSE_DIR_."$video")) 
							{
							$result =  @unlink(_ASS_UPLOAD_VIDEO_PRESSE_DIR_."$video"); 				
							 }
							 ...
							 $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
							 $sql = "Update  "._DB_PREFIX_."presse set video=NULL  WHERE id = ?";
							 $q = $pdo->prepare($sql);
							 $q->execute(array($id));
...
?>
 ...
 <div class="container">
    			...
    			<div class="span10 offset1">
    				<div class="row">
		    			<h3>Supprimer Video Presse</h3>
		    		</div>
		    		
	    			<form class="form-horizontal" action="index.php?page=presse&action=delete_presse_video" method="post">
