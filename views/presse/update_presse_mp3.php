   ...
   if (window.File && window.FileReader && window.FileList && window.Blob)
	{
		...
		switch(ftype)
        {
            case 'video/mp4': case 'audio/mp3': case 'audio/wma':
                break;
            default:
...
function bytesToSize(bytes) {
  ...
  <div class="form-actions">
	<a class="btn" href="index.php?page=presse&action=index#<?=$id;?>">Back</a>
  </div>
					...
					<form class="form-horizontal" action="processuploadmp3presse.php?id=<?=$id;?>" method="post" enctype="multipart/form-data" id="MyUploadForm">
					
					  <p class="alert alert-info" style="width:350px">Taille maximale 2 MB</p>
